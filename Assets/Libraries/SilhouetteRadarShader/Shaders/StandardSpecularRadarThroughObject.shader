...
Shader "RadarShaders/StandardSpecular/RadarThroughObject"
{
	Properties
	{
...
SubShader
		{
			Tags { "RenderType"="Opaque" "PerformanceChecks"="False" "IgnoreProjector" = "True"}
			LOD 200
        ...
        Stencil {
			...
			sampler2D _MainTex, _BumpMap, _NoiseMap;
